...
import portimg from '../images/anderson.jpeg'
        ...
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          ...
          <div className="lg:pl-20">
            <ul role="list">
              ...
              <SocialLink href="https://www.linkedin.com/in/anderson-silva-04b247217/" icon={LinkedInIcon} className="mt-4">
                Follow on LinkedIn
              </SocialLink>
              <SocialLink
                href="mailto:anderson.raul4631@gmail.com"
                icon={MailIcon}
