...
import logoRocketseat from '@/images/logos/logoRocketseat.jpg'
import logoAlura from '@/images/logos/logoAlura.jpg'
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      <h2 className="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
        ...
        <span className="ml-3">Plataforma de Estudos</span>
      </h2>
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Sou Anderson. Desenvolvedor Web, moro na cidade de São Paulo. Neste espaço
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            ...
            />
            <SocialLink
              href="https://github.com/andersonraulino"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/anderson-silva-04b247217/"
